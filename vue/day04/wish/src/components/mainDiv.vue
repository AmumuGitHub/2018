<template>
    <div id="main">
        <dl  v-drag v-for="item in list" :key="item.id"  ref="wish">
            <dt>
            ...
            <dd class="bottom">
                ...
                <a href="javascript:;" class="close" @click=wishDel(item.id)></a>
            </dd>
        </dl>
    </div>
...
export default {
  ...
  methods: {
    ...
    randomWish() {
      ...
      var width = document.documentElement.clientWidth - wishs[0].clientHeight;
  ...
  filters: {
    fmTime: function(time) {
      ...
      var mi = d.getMinutes() > 10 ? d.getMinutes() : "0" + d.getMinutes();
