<template>
  <div class="foot-btn" >
    <ul>
     <!--  <li class="home"><a href="index_m.html"></a></li>
      <li class="write"><a href="javascript:;"></a></li>
      <li class="my"><a href="mydoc_m.html"></a></li> -->
      <router-link tag="li" class="home" active-class="home1" to="/home"><a href="javascript:;"></a></router-link>
      <router-link tag="li" class="write"  active-class="write1" to="/follow"><a href="javascript:;"></a></router-link>
      <router-link tag="li" class="my"  active-class="my1" to="/user"><a href="javascript:;"></a></router-link>
    </ul>
  </div>
</template>
<style>
